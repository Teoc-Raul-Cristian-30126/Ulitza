...
public class UserTest {
    ...
    public void testRemoveProductFromCartThrowsExceptionWhenProductNotFound() throws Exception {
        final User user = new User(200d);
        user.addProductToCart(new Product("p_1", 100d), 2);
    ...
    public void testSubmitCartExceptionThrowsExceptionWhenUserDoesNotHaveEnoughMoney() throws Exception{
        final User user = new User(200d);
        user.addProductToCart(new Product("p_1", 100d), 2);
        user.addProductToCart(new Product("p_2", 100d), 1);
